...
<?php
  include ("code_part/connection.php");
    ...
    $query = "SELECT * FROM tbl_news LIMIT " . $page_first_result . ',' . $results_per_page;  
  ...
  echo '<div class="blog-card">
    <div class="meta">
      <div class="photo" style="background-image: url(admin/'.$row['news_photo'].')"></div>
    </div>
    <div class="description">
      <h1>'.$row['title_of_news'].'</h1>
      <h2>'.$row['post_date'].'</h2>
      <p> '.$row['news_desc'].'</p>
    </div>
  </div>';
...
$less=$_GET['page']-1;
            ...
            echo '
                              <li class="page-item"><a class="page-link" href="news.php?status=News&page='.$less.'">Previous</a></li>
        ';  
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '
                                   ...
                                   <li class="page-item"><a class="page-link" href="news.php?status=News&page=' . $page . '">' . $page . '</a></li>
...
<li class="page-item"><a class="page-link" href="news.php?status=News&page='.$less.'">Next</a></li>
