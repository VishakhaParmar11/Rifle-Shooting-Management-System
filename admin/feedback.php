...
<div class="notification-area mg-b-15">
            <div class="container-fluid">
                ...
                <div class="row" style="height:40pc;">
                ...
                <?php
                        ...
                        $uurl="delete-feed.php?id=".$ids;
                        echo '
                                 <div class="col-lg-4 col-md-3 col-sm-4 col-xs-10">
                    <div class="card_div" style="position:relative; left:40px; width: 380px;">
            <div class="user_div">
                <img src="../../RSMS_Project/Registration/'.$row1['photo'].'">
                <div class="user_name" style="position:relative;width: 274px;">
                    <span class="name" style="position:absolute;top: 3px;width:;">'.$row1['username'].'</span>

                    

                    <a onclick="delete_rec('."'$uurl'".')" >
                    <i class="uil uil-trash-alt icon1" style="position:relative;left:230px;"></i></a>
                    <br>
...
<script type="text/javascript">
    ...
    function feed_ck(id,status)
    {
        window.location.href="feed_ck.php?id="+id+"&st="+status;
    }
</script>
...
<!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                            ...
                            <div class="" style="position:relative; top:-90px;">
                                <ul class="pagination">
