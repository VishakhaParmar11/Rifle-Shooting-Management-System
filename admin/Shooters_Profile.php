<?php
    ...
    $sql="SELECT * FROM `tbl_registration` where `status` = '1' and role='user' limit 4; ";
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap" >
                            ...
                            <!-- <div class="add-product">
                                <a href="#">Shooters Profile View</a>
                            </div> -->
                            <div class="asset-inner" >
                                <table>
                                    <tr>
                                        ...
                                        <th style="color: #06A3DA;">Phone No</th>
                                        <th style="color: #06A3DA;">View</th>
                                    </tr>
                            <style type="text/css">
                                .abc{
                                    position: relative;
...
<?php 
    ...
    while ($row=mysqli_fetch_assoc($run)) 
    {
        ...
        $id=$row['id'];
                                    echo'<tr>
                                        <td>'.$i.'</td>
                                        <td class="vish"><img src="../../RSMS_Project/Registration/'.$row['photo'].'" alt="" /></td>
                                        <td>'.$row['username'].'</td>
                                        <td class="vp">'.$row['hand_selection'].'</td>
                                        <td class="abc">'.$row['email'].'</td>
                                        <td class="pqr">'.$row['gender'].'</td>
                                        <td>'.$row['phone_no'].'</td>
                                        <td>
                                            <a href="shooters_view.php?status=Shooters_Detalis&id='.$id.'">
                                            <i class="fa fa-eye" aria-hidden="true" style="color: #06A3DA; position:relative; left:3px; font-size:25px;"></i>
                                           </a>
                                        </td>
                                    </tr>';
    }
...
$less=$_GET['page']-1;
            ...
            echo '
                              <li class="page-item"><a class="page-link" href="shooters_Profile.php?page='.$less.'">Previous</a></li>
        ';  
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '
                                   ...
                                   <li class="page-item"><a class="page-link" href="shooters_Profile.php?page=' . $page . '">' . $page . '</a></li>
...
<li class="page-item"><a class="page-link" href="shooters_Profile.php?page='.$less.'">Next</a></li>
...
<div class="footer-copyright-area" style="width: 100%;position: absolute;left: 0px;bottom: 0px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
