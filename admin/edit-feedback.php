                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Feedback</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod" style="color: #06A3DA;">Edit Feedback</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Update Feedback Information</a></li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom" style="border: dashed 3px #06A3DA; height:230px; position:relative;">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="Name" type="text" class="form-control" placeholder="Title Name" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="date" type="date" class="form-control" placeholder="Date" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="description" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;"></textarea>
                                                                </div>
                                                                <!-- <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <br><br><button type="submit" class="btn btn-primary " style="background: #06A3DA; width: 100px; height: 35px; font-size:15px;border:2px solid #06A3DA;">Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="devit-card-custom">
                                                            ...
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light" style="border:2px solid #06A3DA;">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
