                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <h3 style="color: #06a3da;font-family: Century;">Manage Gallary</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="product-status mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    ...
                    {
                        $id=$row['id'];
                        $uurl="delete-gallary.php?id=".$id;
                    echo '
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="'.$row['gallary_photo'].'" alt=""/>
                            </div>
                            <div class="student-dtl">
                                <h2>'.$row['title_of_gallary'].'</h2>
                                <a href="edit-gallary.php?status=Gallary&id='.$row['id'].'"> <i class="uil uil-edit icon"></i></a>

                                <a onclick="delete_rec('."'$uurl'".')" >
                                <i class="uil uil-trash-alt icon"></i></a>
                                
                                <p class="dp"><b>'.$row['post_date'].'</b></p>
                                <p class="dp-ag">'.$row['gallary_desc'].'</p>
                            </div>
                        </div><br>
                    </div>';
                }
...
$less=$_GET['page']-1;
            ...
            echo '
                              <li class="page-item"><a class="page-link" href="manage_gallary.php?page='.$less.'">Previous</a></li>
        ';  
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '
                                   ...
                                   <li class="page-item"><a class="page-link" href="manage_gallary.php?page=' . $page . '">' . $page . '</a></li>
...
<li class="page-item"><a class="page-link" href="manage_gallary.php?page='.$less.'">Next</a></li>
