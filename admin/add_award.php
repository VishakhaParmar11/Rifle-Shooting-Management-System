<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="INSERT INTO `tbl_awards` (`id`, `title_of_award`, `award_desc`, `post_date`, `award_photo`) VALUES (NULL, '$award_name', '$award_desc', '$date', '$path');";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Awards Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            document.getElementById('input_file').click();
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="award_name" type="text" class="form-control" placeholder="Title Of Award" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                <!-- <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="award_desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"></textarea>
                                                                </div>
