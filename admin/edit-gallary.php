...
<?php
    ...
    $id=$_GET['id'];
    $sql="SELECT * FROM `tbl_gallary` where id=$id";
    $qry=mysqli_query($con,$sql);
    $row=mysqli_fetch_assoc($qry);

    $title_of_gallary=$row['title_of_gallary'];
    $gallary_desc=$row['gallary_desc'];
    $post_date=$row['post_date'];
    $gallary_photo=$row['gallary_photo'];
    ...
    color: black;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Update Gallary Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            function open_file()
        {
            document.getElementById('input_file').click();
                                                                    ...
                                                                    <div onclick="open_file();" class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom" style="border: dashed 3px #06A3DA; height:200px; position:relative;">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="gallary_name" value="<?php echo $title_of_gallary; ?>" type="" class="form-control" placeholder="Title Of Gallary" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                
                                                                <div class="form-group res-mg-t-15">
                                                                <textarea name="gallary_desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"><?php echo $gallary_desc; ?></textarea>
                                                                </div>
...
<?php 
    if (isset($_POST['update'])) 
    {
        ...
        $gallary_desc=$_POST['gallary_desc'];
        $date = date('m/d/Y', time());
        $f_name=$_FILES['photo']['tmp_name'];
        $path="image/gallary_photo/".$_FILES['photo']['name'];
        
        if (move_uploaded_file($f_name,$path)) 
        {
            $sql1="UPDATE `tbl_gallary` SET `title_of_gallary` = '$gallary_name', `gallary_desc` = ' $gallary_desc', `post_date` = '$date', `gallary_photo` = '$path' where id=$id";
        }
        else 
        {
            $sql1="UPDATE `tbl_gallary` SET `title_of_gallary` = '$gallary_name', `gallary_desc` = ' $gallary_desc', `post_date` = '$date' where id=$id";
        }
        ...
        if ($qry1) 
        {
            ...
            echo "<script>window.location.href='../../../../RSMS_project/admin/manage_gallary.php?status=Gallary';</script>";
        }
    }
?>
