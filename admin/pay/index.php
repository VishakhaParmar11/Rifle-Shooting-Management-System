...
$redirectUrl = 'http://localhost/payment/payment-success.php';
 $callbackUrl = 'http://localhost/payment/payment-callbackUrl.php';
// Set transaction details
$order_id = uniqid(); 
$name="Tutorials Website";
$email="solankiparesh417@gmail.com";
$mobile=9999999999;
$amount =50; // amount in INR
$description = 'Solanki Paresh guid';
