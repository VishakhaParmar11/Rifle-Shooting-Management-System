...
<?php
            ...
            $title_of_activity=$row['title_of_activity'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Update Activity Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            document.getElementById('input_file').click();
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="activity_name"value="<?php echo $title_of_activity; ?>"  type="" class="form-control" placeholder="Title Of Activity" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                
                                                                <div class="form-group res-mg-t-15">
                                                            <textarea name="activity_desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"><?php echo $activity_desc; ?></textarea>
                                                                </div>
...
<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        $path="image/activity_photo/".$_FILES['photo']['name'];
        
        if (move_uploaded_file($f_name,$path)) 
        {
            $sql1="UPDATE `tbl_activity` SET `title_of_activity` = '$activity_name', `activity_desc` = '$activity_desc', `post_date` = '$date', `activity_photo` = '$path' where id=$id";
        }
        else 
        {
            $sql1="UPDATE `tbl_activity` SET `title_of_activity` = '$activity_name', `activity_desc` = '$activity_desc', `post_date` = '$date' where id=$id";
        }
        ...
        if ($qry1) 
        {
            ...
            echo "<script>window.location.href='../../../../RSMS_project/admin/manage_activity.php?status=Activity';</script>";
        }
    }
