...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <?php
            ...
            $title_of_news=$row['title_of_news'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Update News Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick add-professors" >
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <script type="text/javascript">function open_file()
                                                                 {
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="news" type="text" class="form-control" placeholder="Title Of News" value="<?php echo $title_of_news; ?>" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                <!-- <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"><?php echo $news_desc; ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <br><br>
                                                                    <button name="update" type="submit" class="btn btn-success" id="basicSuccessNoDelay" style="background: #06A3DA; width: 100px; height: 35px; font-size:15px;">Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                    <?php 
                                                        ...
                                                        if(isset($_POST['update']))
                                                        {
                                                            ...
                                                            {
                                                                $sql1="UPDATE `tbl_news` SET `title_of_news` = '$news_name', `news_desc` = '$news_desc', `post_date` = '$date ', `news_photo` = '$path' WHERE `tbl_news`.`id` = $id";
                                                            }
                                                            else
                                                            {
                                                                $sql1="UPDATE `tbl_news` SET `title_of_news` = '$news_name', `news_desc` = '$news_desc', `post_date` = '$date' WHERE `tbl_news`.`id` = $id";
                                                            }
