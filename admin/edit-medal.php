...
<?php
            ...
            $id=$_GET['id'];
            $sql="SELECT * FROM `tbl_medal` WHERE id=$id";
            $qry=mysqli_query($con,$sql);
            $row=mysqli_fetch_assoc($qry);

            $title_of_medal=$row['title_of_medal'];
            $medal_desc=$row['medal_desc'];
            $post_date=$row['post_date'];
            $medal_photo=$row['medal_photo'];
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Update Medal Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            document.getElementById('input_file').click();
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="medal_name"value="<?php echo $title_of_medal; ?>" type="" class="form-control" placeholder="Title Of Medal" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                
                                                                <div class="form-group res-mg-t-15">
                                                                <textarea name="medal_desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"><?php echo $medal_desc; ?></textarea>
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    ...
                                                                    <button type="submit" name="update" class="btn btn-success" id="basicSuccessNoDelay" style="background: #06A3DA; width: 100px; height: 35px; font-size:15px;">Update</button>
...
<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        $medal_desc=$_POST['medal_desc'];
        $date = date('m/d/Y', time());
        $f_name=$_FILES['photo']['tmp_name'];
        $path="image/medal_photo/".$_FILES['photo']['name'];
        
        if (move_uploaded_file($f_name,$path)) 
        {
            $sql1="UPDATE `tbl_medal` SET `title_of_medal` = '$medal_name', `medal_desc` = '$medal_desc', `post_date` = '$date', `medal_photo` = '$path' where id=$id";
        }
        else 
        {
            $sql1="UPDATE `tbl_medal` SET `title_of_medal` = '$medal_name', `medal_desc` = '$medal_desc', `post_date` = '$date' where id=$id";
        }
        ...
        if ($qry1) 
        {
            ...
            echo "<script>window.location.href='../../../../RSMS_project/admin/manage_medal.php?status=Medals';</script>";
        }
    }
...
?>
        ...
        <div class="footer-copyright-area" style="position: absolute;bottom: 0;width: 100%;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
