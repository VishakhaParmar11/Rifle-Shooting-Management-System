		...
		<div class="card">
			<div class="card-header">
				<h2>
					...
					<a class="btn btn-info float-right" href="date_view.php" style="background-color:#06A3DA;">View All</a>
				</h2>
			</div>
...
<?php } } ?>
						...
						<tr>
							<td colspan="4" class="text-center">
								<input type="submit" name="submit" class="btn btn-primary px-5" value="Submit" style="background-color: #06A3DA; position: relative; top: 20px;">
							</td>
						</tr>
					</table>
				</form>
