<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(move_uploaded_file($_FILES['photo']['tmp_name'], $path))
        {
             ...
             echo "<script>window.location.href='manage_medal.php';</script>";
        }
        

        $sql="INSERT INTO `tbl_medal` (`id`, `title_of_medal`, `medal_desc`, `post_date`, `medal_photo`) VALUES (NULL, '$medal_name', '$medal_desc', '$date', '$path');";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; left:595px;">
                                        <ul class="breadcome-menu">
                                            <h3 style="position:relative; color: #06A3DA; font-family: centuary; left: 70px;">Medals Information</h3>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            document.getElementById('input_file').click();
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position:relative; top:15px;">
                                                                <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                    <input name="medal_name" type="text" class="form-control" placeholder="Title Of Medal" style="border: 2px solid #06A3DA; border-radius: 10px;">
                                                                </div>
                                                                <!-- <div class="form-group" style="position: relative; border-radius: 30px;">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="medal_desc" placeholder="Description" style="border: 2px solid #06A3DA; border-radius:10px;position: relative;height: 150px;"></textarea>
                                                                </div>
