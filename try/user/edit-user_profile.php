                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            ...
                            <div class="admin" style="position: relative; color:#06A3DA;
                            left: 550px;font-size: 25px;"><i class="uil uil-user" style="position: relative; color:#06A3DA;"></i>&nbsp;
                                Edit Profile
                              </div>
                            </div>
                            <div class="div1" style="position: relative; width:1100px; height:700px; border:2px;">
                                ...
                                <div class="div2" style="position: relative; width:450px;height: 640px; border:3px solid #06a3da; top: 20px; left: 430px; border-radius:20px;
                                   ...
                                   ">
                                        ...
                                        <div class="img">
                                            <img src="img\img9.png" style="position: relative; border-radius:40px;height: 100px; width:100px; top:-20px;left: 170px;">
                                        </div>
                                    ...
                                    <div class="attribute" style="position: relative; top: -30px;left: 170px;font-size: 15px;">
                                        ...
                                        <input type="" name="" placeholder="Enter Name"  class="input3" style="position:relative;  border:2px solid #06a3da; width: 200px;padding: 5px;border-top: none;border-left: none;border-right: none; outline: none;">
                                    </div>
                                    ...
                                    <div class="attribute" style="position: relative; top: -40px;left: 170px;font-size: 15px;">
                                       <input type="email" name="" placeholder="Enter Name"  class="input3" style="position:relative;  border:2px solid #06a3da; width: 200px;padding: 5px;border-top: none;border-left: none;border-right: none; outline: none;">
                                    </div>
                                    ...
                                    <div class="attribute" style="position: relative; top: -40px;left: 170px;font-size: 15px;padding: 5px;">
                                        <input type="date" name="" placeholder="Enter Name"  class="input3" style="position:relative;  border:2px solid #06a3da; width: 200px;padding: 5px;border-top: none;border-left: none;border-right: none; outline: none;">
                                    </div>
                                    ...
                                    <div class="attribute" style="position: relative; top: -40px;left: 170px;font-size: 15px;">
                                        <textarea style="position:relative;border: 2px solid #06a3da;border-right: none;border-left: none;border-top: none;outline: none;"></textarea>
                                        <div>
                                        <button class="btn" style="position:relative; border-radius:10px;border: 2px solid;color: #ffff; background: #06a3da;top: 20px;left: -120px; width: 350px;">Submit</button>
                                        </div>
                                    </div>
