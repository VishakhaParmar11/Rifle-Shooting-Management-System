<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $msg=$_POST['msg'];
        $rat=3;
        $sql1="INSERT INTO `tbl_feedback`(`user_id`, `feed_name`, `feed_desc`,`rat`) VALUES ('$user_id','$uname','$msg','$rat')";
...
<style type="text/css">
    ...
    .btn1:hover
    {
        ...
        <div class="box1">
            ...
            <h5 class="star">Star Rating</h5>
            <span class="fa fa-star checked str"></span>
            <span class="fa fa-star checked str"></span>
            <span class="fa fa-star checked str"></span>
            <span class="fa fa-star str"></span>
            <span class="fa fa-star str"></span>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright 2023 All rights reserved. Template by vishakha And Parmar </p>
                        </div>
                    </div>
                </div>
            </div>
