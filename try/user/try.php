...
echo '
            ...
            <div class="user_div">
                ...
                <div class="user_name" style="position:relative;width: 274px;">
                    <span class="name" style="position:relative;top: -12px;">Parmar Hetal</span><input type="checkbox" value="1" class="switch">&nbsp;<a href="delete_news.php"><i class="uil uil-trash-alt icon1"></i></a>
                    <br>
                    <span class="date" style="position:relative;top: -15px;">20-12-2023</span>
                </div>
            </div>
            <div class="star">
                <!-- Add icon library -->
