                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr class="attribute">
                                        ...
                                        <th style="color:#06A3DA; position:relative; left:-50px;">Name</th>
                                        <th style="color:#06A3DA; position:relative; right:20px;">Fees</th>
                                        <th style="color:#06A3DA; position:relative; right:-12px;">Status</th>
                                        <th style="color:#06A3DA; position:relative; right:12px;">Setting</th>
                                    </tr>
...
$in=$in+1;
$user_gmail=$row['user_gmail'];
    $sql_12="SELECT * FROM `tbl_registration` where email='$user_gmail';";
    $qry_12=mysqli_query($con,$sql_12);
    $row_12=mysqli_fetch_assoc($qry_12);
    echo '<tr>
                                        <td>'.$in.'</td>
                                        <td><img src="../Registration/'.$row_12['photo'].'" alt="" /></td>
                                        <td class="name">'.$row_12['username'].'</td>
                                        <td class="fees">'.$row['fees'].'</td>
                                        <td class="pqr">'.$row['status'].'</td>
                                        <td class="jpg">
                                          <a href="../admin/payment_view/payment_recipt.php?gmail='.$row['user_gmail'].'&fees='.$row['fees'].'">
