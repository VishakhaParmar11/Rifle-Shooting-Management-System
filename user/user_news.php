    ...
    while($row=mysqli_fetch_assoc($run_14))
    {
        $id=$row['id'];                       
                 ...
                 echo'<figure class="news_hor">
                                     <img src="../admin/'.$row['news_photo'].'" style="height:150px;">
                        <figcaption>
...
$less=$_GET['page']-1;
            ...
            echo '
                              <li class="page-item"><a class="page-link" href="user_news.php?page='.$less.'">Previous</a></li>
        ';  
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '
                                   ...
                                   <li class="page-item"><a class="page-link" href="user_news.php?page=' . $page . '">' . $page . '</a></li>
...
<li class="page-item"><a class="page-link" href="user_news.php?page='.$less.'">Next</a></li>
