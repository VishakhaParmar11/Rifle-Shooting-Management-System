...
session_start();
    ...
    $row=mysqli_fetch_assoc($qry);
                        ...
                        if(isset($_POST['submit'])) {
                                               $des=$_POST['ms'];
$sql1="INSERT INTO `tbl_contact_us` (`id`, `cont_name`, `cont_desc`,`user_id`) VALUES (NULL, '$name', '$des',$id);";
...
<body>
  ...
  <div class="container" style="height:500px;">
    ...
    <div class="formBox" style="position:relative; top: -200px;">
        ...
        <!-- Notification End-->
        <div class="footer-copyright-area" style="position: sticky;bottom: 0px; width: 86pc;" >
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
