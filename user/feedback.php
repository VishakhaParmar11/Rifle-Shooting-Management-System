        ...
        $row1=mysqli_fetch_assoc($qry1);
            ...
            <div class="user_div">
                ...
                <div class="user_name" style="position:relative;width: 274px;">
                    <span class="name" style="position:absolute;top: 1px;">'.$row1['username'].'</span>
                    ...
                    <br>
                    <span class="date" style="position:relative;top:2px;">'.$row['post_date'].'</span>
                </div>
            </div>
            <div class="star">
                <!-- Add icon library -->
