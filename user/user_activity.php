            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    echo '<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" >
                        <div class="student-inner-std res-mg-b-30" style="height: 330px;margin-bottom: 20px;">
                            <div class="student-img">
                                <img src="../admin/'.$row['activity_photo'].'" alt="" / style="height:190px; width:350px;">
                            </div>
                            <div class="student-dtl" >
                                <h2>'.$row['title_of_activity'].'</h2>
                               
                                <p class="dp"><b>'.$row['post_date'].'</b></p>
                                <p class="dp-ag abc">'.$row['activity_desc'].'</p>
                            </div>
                        </div><br>
                    </div>';
                    }
